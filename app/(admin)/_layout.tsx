...
export default function AdminLayout() {
  ...
  if (loading) return <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}><ActivityIndicator size="large" color="#15803D" /></View>;
  ...
  return (
    <Stack screenOptions={{ headerStyle: { backgroundColor: '#15803D' }, headerTintColor: 'white' }}>
      ...
      <Stack.Screen name="choferes/crear" options={{ title: 'Crear Chofer' }} />
